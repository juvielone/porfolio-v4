  ...
  return (
    <div className="mt-64 lg:mt-32 h-screen">
      ...
      <div className="grid lg:grid-cols-2 max-w-7xl mt-20 mx-auto ">
        ...
        {/* Line */}
        <div className=" h-screen absolute ml-8 lg:left-1/2 lg:mx-0">
        ...
        {/* Job Content */}
        <div className="  ml-20 mt-8 w- lg:mt-0">
          ...
          <p className="font_content mt-5 w- lg:w-96">
        ...
        {/* Job Content */}
        <div className="  ml-20 mt-16 w- lg:mt-32">
          <h1 className="font_subheading font-bold ">
          ...
          <p className="font_content w- mt-5 lg:w-96">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna
            bibendum ultrices sagittis dictum massa. Viverra adipiscing sem
            odioet tortor viverra.
          </p>
        ...
        {/* Date*/}
        <div className=" ml-20 w-40 lg:mt-32 lg:mr-96">
          <button
